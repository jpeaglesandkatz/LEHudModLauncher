    ...
    public partial class CustomMessageBox : Form
    {
        ...
        public CustomMessageBox(string message, string title, string button1Text, string button2Text, string button3Text = null)
        {
            ...
            using (var g = CreateGraphics())
            {
                ...
                var minWidth = 150; // Increased minimum width
                var minHeight = 45; // Increased minimum height
            ...
            var margin = 40; // Increased margin
            var buttonSpacing = 25; // Increased button spacing
